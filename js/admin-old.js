									...
									if ($_iconPicker.length && !$_iconPicker.siblings('.agsdi-picker-pagination').length) {
										...
										(function($iconPicker) {
											...
											$pagination.after(
												...
												'<span class="agsdi-picker-credit">With free icons by <a href="https://wpzone.co?utm_source=ds-icon-expansion&amp;utm_medium=plugin-credit-link&amp;utm_content=divi-visual-builder" target="_blank">Divi Space</a><span class="agsdi-picker-credit-promo"></span></span>'
											);
											//!free exclude end
										})($_iconPicker);
									}
